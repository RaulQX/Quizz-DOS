        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courses_People_CreatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseAppartenences", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CourseAppartenences_Courses_CourseId",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipAllowed = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseAppartenences_CourseId",
                table: "CourseAppartenences",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseAppartenences_PersonId",
                table: "CourseAppartenences",
                column: "PersonId");
